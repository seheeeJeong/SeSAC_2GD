...
console.log(
  "---------실습: 10000까지의 숫자 중에서 13의 배수이면서 홀수인 숫자 출력하기------------"
);

for (i = 0; i * 13 <= 10000; i++) {
  if ((i * 13) % 2 === 1) {
    console.log(i * 13);
  }
}
...
// 0~100 숫자 중에서 2 또는 5의 배수 총합 구하기
// 나머지연산자 % 사용
